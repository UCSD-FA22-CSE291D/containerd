...
type TaskService interface {
	...
	Pause(ctx context.Context, req *PauseRequest) (*emptypb.Empty, error)
	Resume(ctx context.Context, req *ResumeRequest) (*emptypb.Empty, error)
	...
	Shutdown(ctx context.Context, req *ShutdownRequest) (*emptypb.Empty, error)
}
